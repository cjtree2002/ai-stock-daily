...
AI_COMPANIES = [
    ...
    {"name": "SpaceX（未上市）", "ticker": "N/A",  "keywords": ["SpaceX"]},
    {"name": "Anthropic（未上市）","ticker": "N/A","keywords": ["Anthropic", "Claude"]},
    {"name": "OpenAI（未上市）", "ticker": "N/A",  "keywords": ["OpenAI", "ChatGPT"]},
    {"name": "字节跳动 ByteDance（未上市）","ticker": "N/A","keywords": ["ByteDance", "TikTok"]},
